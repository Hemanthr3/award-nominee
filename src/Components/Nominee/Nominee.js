...
const Nominee = ({nominee,selectedNominee,setSelectedNominee}) => {
  ...
  return (
    <div className={`w-full md:w-[230px] h-[220px] ${selectedNominee !== nominee.id ? "bg-gray-400/30" : "bg-yeloow-300"} p-2 rounded-md flex flex-col items-center justify-around `}>
